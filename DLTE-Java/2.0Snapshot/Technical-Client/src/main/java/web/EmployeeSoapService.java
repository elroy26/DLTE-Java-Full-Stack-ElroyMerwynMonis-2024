 ...
 * 
 */
@WebServiceClient(name = "EmployeeSoapService", targetNamespace = "http://web/", wsdlLocation = "http://localhost:7070/employeeform?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESOAPSERVICE_QNAME = new QName("http://web/", "EmployeeSoapService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7070/employeeform?wsdl");
    ...
    public EmployeeSoap getEmployeeSoapPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://web/", "EmployeeSoapPort"), EmployeeSoap.class, features);
    }
