...
public class MyBankMain {
    public static void main(String[] args) {
        MyBank myBank = new MyBankExecute();
    ...
    private static void addNewLoan(MyBank myBank, Scanner scanner) {
        ...
        scanner.nextLine();
        Loan newLoan = new Loan(loanNumber, loanAmount, loanDate, loanStatus, borrowerName, borrowerContact);
        myBank.addNewLoan(newLoan);
        System.out.println("New loan added successfully!");
    }

    private static void displayLoans(List<Loan> loans, String title) {
        System.out.println("\n" + title + ":");
        if (loans.isEmpty()) {
