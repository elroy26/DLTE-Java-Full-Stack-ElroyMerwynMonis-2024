...
//
////    @Test
//    void signingUp_Success() throws DataAccessException {
...
//        customer.setCustomerStatus("open");
//        customer.setCustomerContact(2345324321L);
//        customer.setUsername("asdf");
//        customer.setUsername("21343234");
//        // Set other properties as needed
//
//        // Call the method under test
//        Customer savedCustomer = repo.signingUp(customer);
//
...
//
//        // Assert that the result matches the input customer object
...
//        // Mock listAllCustomer to return a list with a customer
//        List<Customer> customerList = new ArrayList<>();
//        customerList.add(new Customer(213,"sadfdsf", "asdfasd", "open", 2536271829L, "john123","1321321321",2));
//        when(repo.findByCustomerId("john123")).thenReturn(213);
//
//        // Call the method under test
//        Integer customerId = repo.findByCustomerId("john123");
//
//        // Verify the result
//        assertEquals(213, customerId);
//    }
//
//    @Test
...
//    }
////    @Test
//    void testLoadUserByUsername_CustomerExists() {
//        // Mock findByUserName to return a customer
//        Customer customer = new Customer( "John Doe", "Address", "open", 1234567890L, "john123", "password");
//        when(repo.findByUserName("john123")).thenReturn(customer);
//
//        // Call the method under test
//        UserDetails userDetails = repo.loadUserByUsername("john123");
//
//        // Verify the result
...
//
////    @Test
//    void testLoadUserByUsername_CustomerDoesNotExist() {
//        // Mock findByUserName to return null
//        when(repo.findByUserName("nonexistinguser")).thenReturn(null);
//
//        // Call the method under test and assert that it throws UsernameNotFoundException
//        assertThrows(UsernameNotFoundException.class, () -> repo.loadUserByUsername("nonexistinguser"));
//    }
//
//
//}
